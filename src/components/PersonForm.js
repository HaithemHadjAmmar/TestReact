...
const PersonForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-md mx-auto p-4 bg-gray-100 rounded-lg shadow-lg">
      ...
      {formErrors.nom && <p className="text-red-500">Veuillez saisir le nom.</p>}
      ...
      {formErrors.prénom && <p className="text-red-500">Veuillez saisir le prénom.</p>}
      ...
      {formErrors.date_de_naissance && <p className="text-red-500">Veuillez saisir la date de naissance.</p>}
      ...
      {formErrors.sexe && <p className="text-red-500">Veuillez sélectionner le sexe.</p>}
      ...
      {formErrors.email && <p className="text-red-500">Veuillez saisir une adresse email valide.</p>}
      ...
      {formErrors.password && <p className="text-red-500">Le mot de passe doit contenir au moins 6 caractères.</p>}
